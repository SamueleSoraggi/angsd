...
cat("----------\nangsdFile: ",angsdFile,"  file1:",file1," file2:",file2," file3:",file3," out:",out," addErrors:",addErrors," nIter:",nIter,"\nmaxErr:",maxErr,"\n-----------\n")
...
print("-----------------------------------------------")
print("Step 4/6) Remove ancient transitions G->A + C->T  AND  Add error to transitions")
...
fileOut=paste(out,"NoErrorNoTrans",".txt")
